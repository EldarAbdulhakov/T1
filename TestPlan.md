...
32. Отправка большого количества параллельных запросов 

        ОР: Время отклика соответствует заявленным требованиям, отсутствие ошибок 5хх

33. Длительная нагрузка на сервис

        ОР: Стабильность сервиса сохраняется
