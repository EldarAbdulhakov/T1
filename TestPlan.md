...
* 40% тест-кейсов завершаются неудачно
* Обнаружение блокирующих багов
* Недоступность тестового окружения
* Изменение требований или функциональности
* Отсутствие инструментов, доступа или персонала для продолжения тестирования

## 8. Критерии возобновления тестирования 
* Исправление критической массы багов
* Исправление блокирующих багов
* Восстановление инфраструктуры / окружения
* Тест-кейсы обновлены для изменненных требований 
* Восстановления ресурсов для продолжения тестирования
...
1. Запустить сервис API
2. Получить authToken
3. Создать продукт с id = 13 в статусе "Не готов"
### Шаги:
1. Отправить GET запрос:
...
1. Запустить сервис API
2. Получить authToken
3. Создать продукт с id = 9 в статусе "Готов"
### Шаги:
1. Отправить GET запрос:
...
1. Запустить сервис API
2. Получить authToken
3. Создать продукт с id = 547 в статусе "Готов"
### Шаги:
1. Отправить GET запрос:
